<template>
  <div style="margin: 1rem 2rem">
    <a-card class="card" title="试卷详情" :bordered="false">
      <template #extra>
        <!-- 右上角 -->
              ...
              <a-table-column title="操作" align="center" :width="150">
                <template #cell="{ record }">
                  <a-button
                    ...
                    @click="
                      navigateTo(
                        `/adminer/questionToExam?type=${record.type}&id=${queryId}`,
                      )
                    "
                  >
                    去选题
...
let data = [
  {
    type: "single",
    description:
      "检验学生对所学知识的掌握程度和辨别分析能力，题干在设问上多种多样，选项往往似是而非，迷惑性较强",
  },
  {
    type: "multiple",
    description:
      "检验学生对所学知识的掌握程度和辨别分析能力，题干在选项处多种多样，或者相似但是有些不同，迷惑性强",
  },
  {
    type: "blank",
    description:
      "先给出已知条件，在而后的语句中空出要问的答案以横线代替，以此要求应试者填上正确解",
  },
  {
    type: "code",
    description: "给出实际的编程问题，需要应试者选择对应的编程语言编写代码解决",
  },
  {
    type: "mind",
    description: "给出相对于较为发散的问题，充分考察应试者的思维发散能力",
  },
];
// 定义页面布局
definePageMeta({
