<template>
  <div style="margin: 1rem 2rem;">
    ...
    >
      ...
      >
        <template #columns>
          <a-table-column title="用户ID" data-index="id" align="center" :width="80"></a-table-column>
          <a-table-column title="用户账号" data-index="name" align="center"></a-table-column>
          ...
          <a-table-column title="手机号码" data-index="phone" align="center"></a-table-column>
...
const getList = async () => {
  const {result, sums} = await httpGet(`/api/userList?page=${pagination.value.current}&size=${pagination.value.pageSize}`)
  data.value = result
