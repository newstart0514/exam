<template>
  <div style="margin: 30% 25%" class="rounded">
    <div class="text-size-4xl mb" style="font-family: &quot;jinghong&quot;">
      招聘方登录
    </div>
    <a-form ref="formRef" :model="model" layout="vertical">
      ...
      <a-form-item>
        <a-button style="width: 100%; margin-top: -5rem" @click="back"
          >返回首页</a-button
        >
      </a-form-item>
    </a-form>
