<template>
  <div class="mt ml mr">
    <div>
      ...
      <a-tag color="red" bordered style="margin-top: -1rem; margin-left: 0.8rem"
        >当前参加的考试为: {{ paperInfo.paperName }}</a-tag
      >
      ...
      <a-row :gutter="16">
        <a-col :span="12">
          <a-button
            shape="round"
            @click="back"
            style="margin-left: -0.5rem; position: relative; top: 0.5rem"
            >返回</a-button
          >
        </a-col>
        <a-col :span="12">
